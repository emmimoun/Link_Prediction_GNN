...
jaccard_coefficients_df = get_jaccard_coefficients(mygraph)
...
print("jaccard coef")
print(jaccard_coefficients_df)

print(get_neighbors(mygraph, 14))
print(get_neighbors(mygraph, 15))
visualize_likely_connected_nodes(mygraph, 14, 15)
visualize_likely_connected_nodes(mygraph, 15, 22)
